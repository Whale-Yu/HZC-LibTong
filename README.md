...
湖院实验通是一款浏览器扩展，可在指定网站上提供悬浮式题库搜索功能，帮助用户快速查找实验室安全准入考试的相关题目和答案。
![img1.png](img1.png)
...
1. 下载/克隆项目到本地 ([点我快速下载 HZC_LibTong.zip](https://github.com/Whale-Yu/HZC-LibTong/releases/download/V1.0/HZC_LibTong.zip))
...
## 07 免责声明
本扩展仅用于学习目的，帮助同学复习实验室安全知识。 请遵守相关法律法规和学校规定，合理使用本工具。

## 08 支持与反馈
如果您发现任何问题或有改进建议或者题库更新，请联系开发者： 蟹老板 (v：tinyfisher19)
